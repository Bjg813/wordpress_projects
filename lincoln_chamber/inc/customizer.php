<?php
/**
 * Lincoln_Chamber Theme Customizer.
 *
 ...
 */
function lincoln_chamber_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color', 
				array(
					'label'		=> __( 'Header and footer background color', 'lincoln_chamber'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'lincoln_chamber' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'lincoln_chamber' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'lincoln_chamber' )
		)
	);
	...
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'lincoln_chamber_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'lincoln_chamber_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'lincoln_chamber' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'lincoln_chamber' ),
				'full-content'	=> __( 'Full content', 'lincoln_chamber' )
			),
...
add_action( 'customize_register', 'lincoln_chamber_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function lincoln_chamber_customize_preview_js() {
	wp_enqueue_script( 'lincoln_chamber_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'lincoln_chamber_customize_preview_js' );
...
function lincoln_chamber_sanitize_length( $value ) {
...
if ( ! function_exists( 'lincoln_chamber_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see lincoln_chamber_custom_header_setup().
 */
function lincoln_chamber_header_style() {
